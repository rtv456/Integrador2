        ...
        <div class="modal-dialog">
          <div class="modal-content">
		    ...
		    <div class="form-group">
                    <label for="exampleInputEmail1">HC</label>
                   <input type="hidden" id="crud">
									<input type="hidden" id="txtcode">
									
									<input type="text" class="form-control" id="txtHC" placeholder="">
...
<script>
	...
	$(document).ready(function(){
			...
			"ajax": {
					"url": "../../controlador/PacienteControlador.php",
					"type": "POST",
					"data" : {
						method : "lista"
					},
				...
				{ "data": null, render : function(data,type,row){
					return "<button title='Edit' class='btn btn-edit btn-warning btn-sm'><i class='fa fa-pencil'></i> Ver </button>  <button title='Delete' class='btn btn-hapus  btn-danger btn-sm'><i class='fa fa-remove'></i> Anular</button> ";
				} 		},
				]
	...
	paging: false,
		...
		$(document).on("click",".btn-hapus",function(){
			...
			let idEspecialidad = data.idPaciente;
			...
			$.ajax({
				...
				{					
					...
					if($resp['status'] == true){
						...
						Swal.fire("Error al grabar el paciente : "+$resp['message']);
					}
